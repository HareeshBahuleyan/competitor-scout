...
const filterKeys = ["category", "competitor_id", "confidence_min", "published_from", "published_to", "significance"] as const;
...
export default async function FindingsPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <AppShell><FindingsListView initialFilters={filters} /></AppShell>;
}
